# Sfcc Ci API MCP Server

This MCP (Model Content Protocol) server provides access to Sfcc Ci API API functionality through HTTP, HTTPS, and STDIO transport modes.
